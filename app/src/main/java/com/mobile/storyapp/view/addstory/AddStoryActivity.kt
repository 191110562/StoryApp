package com.mobile.storyapp.view.addstory
...
import com.mobile.storyapp.*
import com.mobile.storyapp.api.ApiConfig
import com.mobile.storyapp.api.FileUploadResponse
...
class AddStoryActivity : AppCompatActivity() {
    ...
    private fun uploadImage() {
        if (getFile != null) {
            ...
            showLoading(true)
            val service = ApiConfig().getApiService(UserPreference.getInstance(dataStore)).uploadImage(imageMultipart, description)
            ...
            Toast.makeText(this@AddStoryActivity, getString(R.string.upload_image), Toast.LENGTH_SHORT).show()
        }
    }
    ...
    private val launcherIntentCamera = registerForActivityResult(
        ...
        if (it.resultCode == RESULT_OK) {
            ...
            binding.profileImageView.setImageBitmap(result)
        }
    }
